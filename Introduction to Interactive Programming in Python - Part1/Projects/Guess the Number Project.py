...
def choose_range(num):
    '''This function allows the user to chose a desired range'''
    global secret_number, number_of_guesses, Range
    Range = int(num)
    secret_number = random.randrange(0, Range)
    number_of_guesses = math.ceil(math.log(Range, 2))
...
frame.add_button("Range 0-100", range100, width)
frame.add_button("Range 0-1000", range1000, width)
frame.add_input("Choose your Range!", choose_range, 176)
frame.add_button("Start New Game", range100, width)
frame.add_input("Enter your number here!", input_guess, 176)
