...
# using Classes, the ball in the canvas will bounce of the walls
# using RectangularDomain or CircleDomain, the shape of the field will change, 
# but thanks to Object Oriented Porgramming, the behavior of the ball will not mutate
